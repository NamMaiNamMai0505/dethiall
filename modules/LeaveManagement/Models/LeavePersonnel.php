...
class LeavePersonnel extends Model
{
    ...
    protected $fillable = ['user_id','unit_id','class_id','staff_code','name','unit','position','object_type','rank','enlistment_date','hometown','permanent_residence','email','gmail','active','commander_user_id','commander_name','class_name','managing_agency'];
