...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="lms-card rounded-2xl overflow-hidden">
        <div class="bg-gradient-to-r from-teal-600 to-teal-500 px-6 py-5 text-white flex flex-wrap items-center justify-between gap-3">
            <h1 class="text-lg font-bold"><i class="bi bi-plus-circle mr-2"></i>Thêm hoạt động ngoài HĐCM</h1>
    ...
    <div class="lms-card rounded-2xl p-5">
        <form action="{{ route('lms.teach.standard-hours.external-activities.store') }}" method="POST"
            ...
            <div class="border-t border-slate-200 mt-6 pt-6 flex justify-end gap-3">
                <a href="{{ route('lms.teach.standard-hours.external-activities.index') }}" class="px-4 py-2.5 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 text-sm font-medium transition-colors">Hủy</a>
