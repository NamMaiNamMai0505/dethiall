...
@section('page-title', 'Tạo mới đơn vị')
            ...
            <div class="mb-6">
                ...
                >
                    ...
                    @foreach($parentUnits as $parentUnit)
                        <option value="{{ $parentUnit->id }}" {{ old('parent_id') == $parentUnit->id ? 'selected' : '' }}>
            ...
            <div class="mb-6">
                ...
                <select name="functional_type" id="functional_type"
                    ...
                    @foreach(\Modules\Unit\Models\Unit::getFunctionalTypeOptions() as $value => $label)
                        <option value="{{ $value }}" @selected(old('functional_type', 'other') === $value)>{{ $label }}</option>
                    @endforeach
                </select>
