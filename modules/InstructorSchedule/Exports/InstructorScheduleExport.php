...
namespace Modules\InstructorSchedule\Exports;
...
class InstructorScheduleExport implements FromArray, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    ...
    public function __construct($scheduleData, $startDate, $endDate, $instructor)
    {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Main title: merge across D1:G2
                $sheet->setCellValue('D1', 'LỊCH GIẢNG DẠY');
                ...
                $instructorName = $this->instructor->name ?? 'N/A';
                $sheet->setCellValue('D3', 'Giảng viên: '.$instructorName);
