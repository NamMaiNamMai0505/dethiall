...
class StoreConversionRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['sometimes', 'in:'.ConversionRecord::STATUS_DRAFT.','.ConversionRecord::STATUS_SUBMITTED],
        ];
    }
    ...
    {
        if (! $this->has('status')) {
            $this->merge(['status' => ConversionRecord::STATUS_DRAFT]);
        }
