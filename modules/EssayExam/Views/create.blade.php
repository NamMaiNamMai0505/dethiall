...
if (actualImportForm) {
  const importLabels = {import_subject_id:'Môn học', duration_minutes:'Thời gian làm bài (phút)', import_file:'File câu hỏi / bộ đề'};
  ...
  const firstImportField = actualImportForm.querySelector('[name="import_subject_id"]')?.closest('label');
