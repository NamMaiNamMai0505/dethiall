...
Route::middleware(['web','auth'])->prefix('essay-exams')->name('essay-exams.')->group(function () {
    ...
    Route::get('/mine', [EssayExamController::class, 'mine'])->middleware('permission:essay-exams.mine')->name('mine');
    ...
    Route::get('/integrated-answers', [EssayExamController::class, 'integratedAnswers'])->middleware('permission:essay-exams.mine|essay-exams.index')->name('integrated-answers.index');
    Route::get('/integrated-answers/{answerSet}', [EssayExamController::class, 'integratedAnswerShow'])->middleware('permission:essay-exams.show|essay-exams.index')->name('integrated-answers.show');
    ...
    Route::get('/{essayExam}', [EssayExamController::class, 'show'])->middleware('permission:essay-exams.show|essay-exams.index')->name('show');
    Route::get('/{essayExam}/source-pdf', [EssayExamController::class, 'sourcePdf'])->middleware('permission:essay-exams.show|essay-exams.index|essay-exams.approval.index')->name('source-pdf');
