...
<body>
<iframe id="inventory-pdf" title="{{ $title }}"></iframe>
<div class="fallback"><button type="button" onclick="printInventoryPdf()">{{ $buttonLabel ?? 'In tài liệu' }}</button></div>
<script>
...
const frame = document.getElementById('inventory-pdf');
...
frame.addEventListener('load', function () {
    setTimeout(printInventoryPdf, 600);
});
frame.src = pdfUrl;
</script>
</body>
