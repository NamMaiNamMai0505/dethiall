...
namespace Modules\StudentSchedule\Exports;
...
class StudentScheduleExport implements FromArray, WithColumnWidths, WithEvents, WithStyles, WithTitle
{
    ...
    public function __construct($scheduleData, $startDate, $endDate, $student, $className)
    {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('D1', 'LỊCH HỌC');
                ...
                // Row 3: Class name
                $sheet->setCellValue('D3', 'Lớp: '.$this->className);
