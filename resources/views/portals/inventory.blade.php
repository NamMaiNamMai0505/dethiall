...
<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    @foreach([
        ...
        ['route'=>'inventory.category','permission'=>'inventory.categories.index','label'=>'Ngành vật tư','desc'=>'Phân nhóm ngành, phân quyền phụ trách','icon'=>'bi-diagram-3'],
        ['route'=>'inventory.types','permission'=>'inventory.categories.index','label'=>'Loại vật tư','desc'=>'Danh mục loại và nhóm vật tư','icon'=>'bi-tags'],
        ['route'=>'inventory.materials','permission'=>'inventory.materials.index','label'=>'Vật tư','desc'=>'Danh sách vật tư, import và cập nhật tồn','icon'=>'bi-box-seam'],
